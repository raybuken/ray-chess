...
export default function Game(){
    return (
        <ChessBoardProvider>
            <h1 className="brand">Ray Chess</h1>
            <Board/>
            <a href="https://github.com/raybuken" className="link" target="_blank" rel="noreferrer">
                <svg className="github-icon" width="32" height="32" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
